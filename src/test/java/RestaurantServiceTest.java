...
class RestaurantServiceTest {
    ...
    public void setUp() {
        ...
        restaurant = service.addRestaurant("Costa Rica","Bangalore",openingTime,closingTime);
    ...
    public void searching_for_non_existing_restaurant_should_throw_exception() {
        assertThrows(restaurantNotFoundException.class, () -> service.findRestaurantByName("Starbucks"));
    }
    //<<<<<<<<<<<<<<<<<<<<SEARCHING>>>>>>>>>>>>>>>>>>>>>>>>>>
    ...
    public void remove_restaurant_should_reduce_list_of_restaurants_size_by_1() throws restaurantNotFoundException {
        ...
        service.removeRestaurant("Costa Rica");
